...
var ExecutionLogicModule = (function () {
  ...
  function update_launch_button() {
    ...
    switch (current_status) {
      case CODE_STATUS.PAUSED:
        ...
        launch_button.removeClass('btn-success btn-default btn-warning disabled');
  ...
  function initApi(interpreter, scope) {
    ...
    interpreter.setProperty(scope, 'publish', interpreter.createNativeFunction(wrapper));
  ...
  function set_status(value) {
    ...
    update_workspace();
    if ([CODE_STATUS.NOT_CONNECTED, CODE_STATUS.COMPLETED].indexOf(current_status) >= 0) {
